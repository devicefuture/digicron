...
Then to run the simulator locally, you need to start a web server in this directory. You can run the following to start the web server at [localhost:8000](http://localhost:8000):
